...
- **Уведомления о луте и прокачке навыка**, события через **`eventBus`**.
- **Радиальное меню** по **E** у интерактивных объектов сцены (осмотреть / взять / использовать / выбросить).
- **Миникарта**: маркеры целей квестов (зона / цель).
...
- **Туториал** в режиме обхода (WASD, E, I; контекст у NPC; отключение).
