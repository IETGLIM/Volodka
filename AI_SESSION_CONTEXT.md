...
- **Thought Cabinet** — 18 мыслей, 3 mutually exclusive пары, макс. 3 экипированных
...
| `src/data/thoughtCabinet.ts` | Определения 18 мыслей для Thought Cabinet |
...
- [ ] **Фаза 5: Расширение Актов 2-7** — аналогичный контент для каждого акта
  - Каждый акт: +30 нод диалога для ключевых NPC, +20 нод исследования
  - Целевое добавление: ~350 нод нового контента
