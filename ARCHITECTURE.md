...
- Парсинг JSON-чанков всех 31 draco-вариантов public/models: ~0.1 MB
  встроенных текстур суммарно. У 19 NPC/героя/пропсов кафе — изображение-
  заглушка (mimeType без bufferView, 0 байт данных); у 10 интерьеров — один
  12K палитровый PNG (колоркарта). На таких текстурах ETC1S РАСТЁТ
