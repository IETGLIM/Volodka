...
export const STORY_NODES: Record<string, StoryNode> = {
  ...
  start: {
    id: 'start',
    text: 'Ты просыпаешься от назойливого писка терминала. Тусклый свет монитора едва прорезает полумрак комнаты. На экране — новое сообщение от IT-гильдии. За окном моросит дождь, и город тонет в привычной серости. Твоё имя — Володька, и сегодня всё изменится.',
    speaker: 'narrator',
  ...
  balcony_thought: {
    id: 'balcony_thought',
    text: 'Ты выходишь на балкон. Холодный ветер бьёт в лицо, но ты не уходишь. Город раскинулся внизу — море огней, мерцающих как стихи на экране. Где-то там, за неоновыми вывесками, живут люди, которые тоже слышат ритм в машинном коде. Ты чувствуешь, как слова складываются сами — строка за строкой, как будто город диктует.',
    speaker: 'narrator',
    sceneId: 'home_evening',
    choices: [
      {
  ...
  friday_arrives: {
    id: 'friday_arrives',
    text: 'Пятница. Вечер. Город зажигает огни, но ты не чувствуешь праздника. Комната кажется особенно пустой — только гул серверов да мигание светодиодов. Ты садишься на край кровати и смотришь на свои руки. Строчки кода, строчки стихов — всё сливается. За стеной кто-то включает музыку, и ты вдруг понимаешь, как одинок.',
    speaker: 'narrator',
    sceneId: 'volodka_room',
    choices: [
      {
  ...
  act5_revolution_path: {
    ...
    text: 'Революция — не романтика. Это бессонные ночи, страх, потери. Но и — надежда, единство, свобода. Сеть становится настоящей силой: люди выходят на улицы не с лозунгами, а со стихами. Гильдия трещит по швам. Александр исчезает. Власть рушится, и на её месте — пока пустота. Что ты построишь на руинах?',
    speaker: 'narrator',
    sceneId: 'street_night',
    choices: [
      {
  ...
  act5_exile_path: {
    id: 'act5_exile_path',
    text: 'Ты уходишь на рассвете. Рюкзак с тетрадями, чип Виктории, несколько стихотворений наизусть — вот и всё твоё богатство. За городом — пустошь, заброшенные серверные фермы, мёртвые зоны без связи. Но и — тишина. Свобода. Ты идёшь, не оглядываясь. Стихи звучат в голове, как прощальный хор. Ты — изгой. Но ты — свободен.',
    speaker: 'narrator',
    sceneId: 'street_winter',
    choices: [
      {
