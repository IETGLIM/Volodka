...
import { toRolldownGroups, CODE_SPLITTING_GROUPS, MIN_CHUNK_SIZE } from './vite/chunks';
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    build: {
      target: 'esnext',
      // [VITE-8] Rolldown replaces Rollup. manualChunks (object form) removed,
      // function form deprecated. Use codeSplitting.groups instead.
      rolldownOptions: {
        output: {
          codeSplitting: {
