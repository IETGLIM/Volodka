 ...
 *
 * [roadmap:GFX-22] `npm run build` uses `budgets:check` (enforcing) — NOT
 * `budgets` (which passes `--report` and never fails). `build:analyze` keeps
 * `--report` for analysis mode where you want the table even if over budget.
 */
