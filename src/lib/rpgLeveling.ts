...
/**
 * Максимум «возраста героя» в нарративе (уровни = прожитые «годы» опыта, потолок 35 лет).
 * Согласовано с UI орбита-панели и `LevelUpCinematicOverlay`.
 */
export const RPG_MAX_CHARACTER_LEVEL = 35;
