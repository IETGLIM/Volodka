...
export const GOLDEN_PATH_BRANCH_HINTS: Record<string, string> = {
  ...
  cafe_albert_napkin: 'Изучи салфетку — комментарий и есть стих.',
  pier_midnight_fishing_sit: 'Прислушайся к воде — завод гудит под сваей.',
  pier_midnight_fishing_bass: 'Трофим готов говорить — кивни.',
  pier_midnight_fishing_key: 'Запомни третью сваю — ключ от подвала.',
  ...
  office_server_pulse: 'Сергей видит ночные логи — спроси, пока гильдия не смотрит.',
  ...
  act4_public_leader: 'Мирный марш на площади — сила в правде, не в насилии.',
  ...
  act6_rooftop_showdown: 'Идеи меняются — перепиши Тень или прими её.',
  act6_final_confrontation: 'Хранитель или освободитель — финальный выбор на крыше завода.',
  pier_story_intro: 'Ночная рыбалка с Трофимом — или струны для Ритки.',
  library_story_intro: 'Подвал библиотеки хранит архив, списанный в утиль. Ключ — в Запретном Фонде.',
  factory_story_intro: 'Верни память «Зари-М» — или попей чай с Бабой Зиной.',
  resistance_bunker_hub: 'Обустрой бункер — перебежчик ждёт спасения.',
  epilogue_hub: 'Письма от всех — или памятник поэтам в парке.',
  act4_quiet_hour: 'Потрать час на близких перед штурмом башни.',
  chk_portwine_delivery_start: 'Донеси портвейн «777» из подсобки кафе — не открывая по дороге.',
  // Act 7
