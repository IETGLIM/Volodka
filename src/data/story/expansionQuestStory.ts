...
export const STORY_NODES_EXPANSION_QUESTS: Record<string, StoryNode> = {
  ...
  act2_street_chk_samizdat_deliver: {
    ...
    text: 'Басед принимает пакет у огня, не задавая вопросов. «Зарема знает протокол.» Он вытаскивает лист — почерк разный, ритм один. «Это пойдёт на стену. И в архив. Спасибо, что ногами, а не VPN. Гильдия VPN любит.»',
    speaker: 'Басед',
