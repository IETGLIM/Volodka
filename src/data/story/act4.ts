...
export const STORY_NODES_ACT4: Record<string, StoryNode> = {
  ...
  vera_inspiration: {
    id: 'vera_inspiration',
    text: 'Солныш — самая молодая в Сети, ей семнадцать — подходит к тебе с горящими глазами. «Мне приснилось стихотворение,» — говорит она. «Во сне я видела город, где каждый экран показывает стихи. Где код — это поэзия, а не тюрьма. Где слова свободны.» Она протягивает тебе исписанный листок. Её вера — как искра в темноте.',
    speaker: 'narrator',
