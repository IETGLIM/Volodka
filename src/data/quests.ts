...
export const QUEST_DEFINITIONS: Record<string, ExtendedQuest> = {
  ...
  main_goal: {
    ...
    description: 'Оставить после себя что-то важное. Найти смысл в 12 годах техподдержки и превратить боль в искусство.',
    type: 'main',
    status: 'active',
    objectives: [
      ...
      createObjective('perform_live', 'Выступить публично', {
        hint: 'Посети кафе "Синий кот" в пятницу вечером',
  ...
  first_reading: {
    ...
    objectives: [
      createObjective('go_to_cafe', 'Посетить "Синий кот" в пятницу', {
  ...
  maria_connection: {
    id: 'maria_connection',
    title: '💫 Связь с Марией',
    description: 'Узнать Марию лучше и понять её историю',
    type: 'main',
    status: 'locked',
    prerequisite: 'first_reading',
    objectives: [
      createObjective('talk_maria', 'Поговорить с Марией о творчестве', {
        hint: 'Найди Марию в кафе и поговори',
  ...
  coffee_affair: {
    ...
    description: 'Стать постоянным посетителем "Синего кота"',
    type: 'side',
    status: 'locked',
    objectives: [
      createObjective('visit_cafe', 'Посетить кафе', { 
        targetValue: 5, 
        currentValue: 0,
        hint: 'Ходи в "Синий кот" регулярно',
        targetLocation: 'cafe_evening'
      }),
