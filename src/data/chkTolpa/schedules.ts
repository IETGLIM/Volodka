...
const CHK_RU_DAY: NPCSchedule = {
  ...
  entries: [
    ...
    { startHour: 8, endHour: 12, sceneId: 'office_day', position: [-2.0, 0, 1.5], activity: 'work' },
    { startHour: 12, endHour: 13, sceneId: 'cafe_evening', position: [-1.5, 0, 0.5], activity: 'rest' },
    { startHour: 13, endHour: 19, sceneId: 'office_day', position: [-2.0, 0, 1.5], activity: 'work' },
...
const CHK_BASED_DAY: NPCSchedule = {
  ...
  entries: [
    ...
    { startHour: 7, endHour: 12, sceneId: 'office_day', position: [2.5, 0, -2.0], activity: 'work' },
    { startHour: 12, endHour: 13, sceneId: 'cafe_evening', position: [1.0, 0, 0.5], activity: 'rest' },
    { startHour: 13, endHour: 18, sceneId: 'office_day', position: [2.5, 0, -2.0], activity: 'work' },
 ...
 *  DevOps guest: works office shifts by day, joins CHK campfire gatherings by night. */
...
/** Analyst guest: researches by day at library, joins CHK discussions by evening. */
const CHK_GUEST_ANALYST: NPCSchedule = {
  id: 'schedule_chk_guest_analyst',
  npcId: 'chk_guest_analyst',
  entries: [
    { startHour: 0, endHour: 7, sceneId: 'cafe_evening', position: [1.0, 0, 1.0], activity: 'sleep' },
    { startHour: 7, endHour: 9, sceneId: 'cafe_evening', position: [1.0, 0, 1.0], activity: 'rest' },
    { startHour: 9, endHour: 17, sceneId: 'library_day', position: [-1.2, 0, 0.8], activity: 'read' },
    { startHour: 17, endHour: 19, sceneId: 'cafe_evening', position: [-0.5, 0, 1.5], activity: 'talk' },
    { startHour: 19, endHour: 22, sceneId: 'chk_forest_zorge', position: [2.0, 0, 0.5], activity: 'talk' },
    { startHour: 22, endHour: 24, sceneId: 'street_night', position: [0, 0, -2.0], activity: 'walk' },
  ],
};
