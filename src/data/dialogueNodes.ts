...
export const DIALOGUE_NODES: Record<string, DialogueNode> = {
  ...
  zarema_daily_life: {
    ...
    speaker: 'Зарема',
    text: 'Как я здесь оказалась? Долгая история. Я из маленького города на юге. Приехала сюда учиться на медика, но... деньги кончились, стипендия маленькая. Устроилась в столовую. А потом познакомилась с тобой и Альбертом, и как-то... осталась. Знаешь, в этом сером городе только наша коммуналка feels like home.',
    choices: [
      {
