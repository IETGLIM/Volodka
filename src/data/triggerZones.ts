...
export const TRIGGER_ZONES: TriggerZone[] = [
  ...
  },
  {
    ...
    // FIX (v4.10.0): hiddenWhenFlag 'final_poem_read' убран — флаг теперь
    // ставится visit-эффектами узла при первом входе, и зона должна остаться
    // доступной для повторного открытия тетради (хуки активации «Мира Снов»).
    requiredAct: 5,
    interactionType: 'read',
  ...
  /* ═══════════════════════════════════════════════════════════════
     FIX (reachability): точки добычи для гиверов-заглушек — материалы
     кузнеца (blacksmith_special), ящик торговца (lost_shipment),
     документы о коррупции (guard_bribe_evidence), чертёж «Око»
     (factory_secret_blueprint). Без этих зон предметы были
     неполучаемы — цели item_collected квестов не выполнялись.
     ═══════════════════════════════════════════════════════════════ */
  {
    ...
    isOneTime: true,
    examineData: {
      title: 'Ящик с синей печатью',
      description: 'Перевёрнутая телега, рассыпанный товар. Ящик — целый, печать гильдии купцов не сорвана.',
      detailText: '«Борис и сыновья — доставка в срок». Кто-то тащил ящик сюда от оврага и бросил, почуяв патруль. Товар терпелив: ждёт честного курьера.',
      icon: '📦',
    },
    effects: [
      { type: 'addItem', itemId: 'boris_shipment_crate', value: 1 },
      { type: 'addKarma', value: 1 },
    ],
    propModelId: 'polyhaven_cardboard_box',
    propOffset: [0, 0.35, 0],
  },
  {
    id: 'blacksmith_ore_vein',
    sceneId: 'abandoned_factory',
    position: [4.0, 0.4, -3.0],
    size: [1.0, 1.2, 1.0],
    enterToast: 'В обвалившейся штольне — синеватый блеск руды.',
    interactionType: 'take',
    isOneTime: true,
    examineData: {
      title: 'Синеватая руда',
      description: 'Заброшенная шахта под заводским крылом. В породе — тяжёлые прожилки, пахнет грозой.',
      detailText: 'Руда, которую Игнат называет «грозовой»: синеватая, тяжёлая, гудит в ладони после удара молота. Кусок размером с кулак — то, что нужно для клинка.',
      icon: '⛏️',
    },
    effects: [
      { type: 'addItem', itemId: 'rare_iron_ore', value: 1 },
      { type: 'addSkill', skill: 'coding', value: 1 },
    ],
    propModelId: 'ai3dgen_server_fragment',
    propOffset: [0, 0.4, 0],
  ...
  {
    id: 'blacksmith_crystal_pool',
    sceneId: 'park_day',
    position: [-4.5, 0.3, -3.5],
    size: [0.9, 1.0, 0.9],
    enterToast: 'За родником у старой ограды что-то мерцает.',
    interactionType: 'take',
    isOneTime: true,
    examineData: {
      title: 'Осколок кристалла',
      description: 'Родник пробил известняк, а вымыл на свет осколок — гранёный, как осколок утра.',
      detailText: 'Кристалл, ровный и без трещин, — «пещерный свет» в словах Игната. Такой режет туман лучше любого фонаря.',
      icon: '💎',
    },
    effects: [
      { type: 'addItem', itemId: 'crystal_shard', value: 1 },
      { type: 'addSkill', skill: 'intuition', value: 1 },
    ],
    propModelId: 'ai3dgen_digital_amulet',
    propOffset: [0, 0.3, 0],
  ...
  {
    id: 'blacksmith_lizard_shed',
    sceneId: 'river_pier',
    position: [3.5, 0.2, -4.0],
    size: [1.0, 0.8, 1.0],
    enterToast: 'На камнях у воды — блестящая чешуя. Здесь линял ящер.',
    interactionType: 'take',
    isOneTime: true,
    examineData: {
      title: 'Драконья чешуя',
      description: 'Ящеры линяют у тёплых стоков. Чешуя — в поправку: тверже стали, легче чешуи судьбы.',
      detailText: 'Пласт чешуи с радужным отливом — то самое, из чего Игнат обещал выковать лезвие, «лёгкое, как перо, прочное, как Bulldozer».',
      icon: '🐲',
    },
    effects: [
      { type: 'addItem', itemId: 'dragon_scale', value: 1 },
      { type: 'addSkill', skill: 'empathy', value: 1 },
    ],
    propModelId: 'polyhaven_barrel',
    propOffset: [0, 0.3, 0],
  },
  {
    id: 'corruption_document_barracks',
    sceneId: 'office_day',
    position: [-3.0, 0.9, -2.5],
    size: [0.9, 1.0, 0.9],
    enterToast: 'В ящике стола дежурного — папка без описи.',
    interactionType: 'take',
    isOneTime: true,
    examineData: {
      title: 'Реестр «проверок»',
      description: 'Казённый стол, замок ящика — откровенно сломан: Гарольд не ждал аудитории.',
      detailText: 'Первый документ: список торговцев с пометками сумм и «гладких» дат проверок. Почерк один — уверенный, канцелярский. Имена, суммы, даты — сделка в трёх колонках.',
      icon: '📄',
    },
    effects: [
      { type: 'addItem', itemId: 'corruption_document_1', value: 1 },
      { type: 'addKarma', value: 1 },
    ],
    propModelId: 'kenney_desk',
    propOffset: [0, 0.4, 0],
  ...
  {
    id: 'corruption_document_office_safe',
    sceneId: 'office_day',
    position: [3.5, 0.9, -3.0],
    size: [0.9, 1.0, 0.9],
    enterToast: 'За портретом бывшего командира — скрытый сейф.',
    interactionType: 'take',
    isOneTime: true,
    examineData: {
      title: 'Документ из-за портрета',
      description: 'Портрет командира висит криво. За ним — ниша с папками.',
      detailText: 'Второй документ: разовая расписка за «тишину на восточном блокпосту». Подпись — «Г.» Всё, чего хватит для суда.',
      icon: '📑',
    },
    effects: [
      { type: 'addItem', itemId: 'corruption_document_2', value: 1 },
      { type: 'addKarma', value: 1 },
    ],
    propModelId: 'kenney_city_bookshelf',
    propOffset: [0, 0.4, 0],
  },
  {
    id: 'factory_eye_blueprint_cache',
    sceneId: 'abandoned_factory',
    position: [-4.0, 0.4, -4.0],
    size: [1.0, 1.2, 1.0],
    enterToast: 'За дальним станком — свежая кладка: кто-то прятал тайник недавно.',
    interactionType: 'take',
    isOneTime: true,
    hiddenWhenFlag: 'eye_blueprint_taken',
    examineData: {
      title: 'Тайник за станком',
      description: 'Кладка сломана изнутри: кто-то прятал свёрток и вернётся за ним.',
      detailText: 'Свёрток в промасленной тряпице. Внутри — ватман, вычерченный до последнего винта: линзы, угол обзора, сетка слежения. «Око». Система, которую Володька стёр однажды сам. Кто-то восстанавливает её по памяти — или по этой копии.',
      icon: '📐',
    },
    effects: [
      { type: 'addItem', itemId: 'eye_blueprint', value: 1 },
      { type: 'setFlag', flag: 'eye_blueprint_taken', flagValue: true },
      { type: 'addStat', stat: 'stress', value: 2 },
    ],
    propModelId: 'ai3dgen_encrypted_scroll',
    propOffset: [0, 0.35, 0],
  ...
  /* ═══════════════════════════════════════════════════════════════
     «МИР СНОВ» (v4.10.0) — зоны-сеттеры целей контент-пака.
     ИНВАРИАНТ ГЕЙТОВ: все зоны гейтятся requiredFlag, выставляемым
     ОДНОВРЕМЕННО с активацией квеста (dream_world_opened — дитя,
     void_echo_quest_started — поэт и эха; см. phase5QuestStory.ts,
     узел vladimir_secret_room_read). Цель, выполненная до активации,
     добирается ретроактивно (QuestTracker.retroactiveCheck на
     quest:accepted) — но никогда не требуются зоны, недоступные
     до активации.
     ═══════════════════════════════════════════════════════════════ */

  /* ─── Сон (sleep_dream): дитя у фонаря — dreamworld_lost_child ─── */
  {
    id: 'dream_lantern',
    sceneId: 'sleep_dream',
    position: [0, 1.2, 3.0],
    size: [1.2, 2.0, 1.2],
    enterToast: 'Фонарь горит сквозь туман. Под ним кто-то маленький ждёт.',
    linkedQuestId: 'dreamworld_lost_child',
    linkedStoryNodeId: 'dream_child_meet',
    requiredFlag: 'dream_world_opened',
    hiddenWhenFlag: 'dream_child_met',
    interactionType: 'talk',
    interactionLabel: 'Подойти к дитю у фонаря',
    propModelId: 'polyhaven_street_lamp',
    propOffset: [0, 1.0, 0],
  },
  {
    id: 'dream_memory_mother',
    sceneId: 'sleep_dream',
    position: [-3.0, 1.0, 2.0],
    size: [1.0, 1.4, 1.0],
    enterToast: 'У кромки воды воздух пахнет хлебом, которого здесь не пекли.',
    linkedQuestId: 'dreamworld_lost_child',
    requiredFlag: 'dream_world_opened',
    isOneTime: true,
    interactionType: 'take',
    interactionLabel: 'Взять воспоминание о матери',
    examineData: {
      title: 'Воспоминание о матери',
      description: 'Сгусток света в форме женского силуэта у самой воды.',
      detailText: 'Вода помнит мать: тёплые руки, запах хлеба, колыбельная без слов. Коснись — и свет пойдёт с тобой, тихий, как будто издалека.',
      icon: '🕯️',
    },
    effects: [
      { type: 'addItem', itemId: 'child_memory_mother', value: 1 },
      { type: 'showThought', thought: 'Хлеб, радио, тёплые руки. Это не моё воспоминание — но держится в ладонях, как родное.', thoughtDuration: 6000 },
    ],
  },
  {
    id: 'dream_memory_school',
    sceneId: 'sleep_dream',
    position: [3.0, 1.0, 2.0],
    size: [1.0, 1.4, 1.0],
    enterToast: 'Скелет школы из тумана: мел, звонок, первый день.',
    linkedQuestId: 'dreamworld_lost_child',
    requiredFlag: 'dream_world_opened',
    isOneTime: true,
    interactionType: 'take',
    interactionLabel: 'Взять воспоминание о школе',
    examineData: {
      title: 'Воспоминание о школе',
      description: 'Светящийся шар с запахом мела и звонком на урок.',
      detailText: 'Класс без стен, доска в тумане. Первый день: чужие лица, страх, который потом станет любовью к знанию. Шар тёплый, как поднятая рука.',
      icon: '🔔',
    },
    effects: [
      { type: 'addItem', itemId: 'child_memory_school', value: 1 },
      { type: 'showThought', thought: 'Мел, звонок, первый день. Дитя не умело читать — но держало тетрадь правильно.', thoughtDuration: 6000 },
    ],
  },
  {
    id: 'dream_memory_poems',
    sceneId: 'sleep_dream',
    position: [0, 1.0, -3.0],
    size: [1.0, 1.4, 1.0],
    enterToast: 'В центре сну — свет, пульсирующий в ритме ямба.',
    linkedQuestId: 'dreamworld_lost_child',
    requiredFlag: 'dream_world_opened',
    isOneTime: true,
    interactionType: 'take',
    interactionLabel: 'Взять воспоминание о стихах',
    examineData: {
      title: 'Воспоминание о стихах',
      description: 'Самое яркое воспоминание дитя. Свет пульсирует в ритме ямба.',
      detailText: 'Мать читала стихи перед сном — те же, что пульсируют в leaking-потоке серверов города. Не совпадение. Связь. Свет отдаётся легко: стихам нужен читатель.',
      icon: '📖',
    },
    effects: [
      { type: 'addItem', itemId: 'child_memory_poems', value: 1 },
      { type: 'addSkill', skill: 'intuition', value: 1 },
    ],
  },
  {
    ...
    position: [0, 1.0, 5.0],
    size: [1.4, 1.8, 1.4],
    enterToast: 'Дитя стоит у края сна — там, где фонари кончаются.',
    linkedQuestId: 'dreamworld_lost_child',
    linkedStoryNodeId: 'dream_child_farewell',
    requiredFlag: 'dream_world_opened',
    hiddenWhenFlag: 'dream_child_guided',
    interactionType: 'talk',
    interactionLabel: 'Вернуться к дитю у края сна',
  },
  {
    id: 'void_poet_edge',
    sceneId: 'sleep_dream',
    position: [-4.5, 1.0, -6.5],
    size: [1.5, 2.0, 1.5],
    enterToast: 'Дальше фонарей — чистое «ничего». В нём — чей-то силуэт. Спиной к тебе.',
    linkedQuestId: 'void_echo_poem',
    linkedStoryNodeId: 'void_poet_gate',
    requiredFlag: 'void_echo_quest_started',
    hiddenWhenFlag: 'void_poet_met',
    interactionType: 'talk',
    interactionLabel: 'Подойти к силуэту на краю сна',
  },

  /* ─── Явь: три источника эха — void_echo_poem ───
     Кумулятивный гейт void_echo_all_heard выставляет QuestTracker,
     когда все три эха услышаны (см. QuestTracker.checkNewFlags). ─── */
  {
    id: 'void_echo_river_pier',
    sceneId: 'river_pier',
    position: [-0.6, 0.5, -6.8],
    size: [1.2, 1.2, 1.2],
    enterToast: 'Вода у причала повторяет чужие слова — слово в слово, но не твоим голосом.',
    linkedQuestId: 'void_echo_poem',
    requiredFlag: 'void_echo_quest_started',
    hiddenWhenFlag: 'void_echo_river',
    interactionType: 'examine',
    interactionLabel: 'Прислушаться к эху у воды',
    examineData: {
      title: 'Эхо у реки',
      description: 'Река повторяет строку, которой не было в твоих тетрадях.',
      detailText: '«return void; — но пустота возвращается не пустой». Вода дробит строку на слоги и складывает обратно — чуть иначе. Первое эхо услышано. Осталось два.',
      icon: '🌊',
    },
    effects: [
      { type: 'setFlag', flag: 'void_echo_river', flagValue: true },
      { type: 'addSkill', skill: 'intuition', value: 1 },
    ],
  },
  {
    id: 'void_echo_rooftop',
    sceneId: 'rooftop_edge',
    position: [-2.4, 0.5, 2.2],
    size: [1.2, 1.2, 1.2],
    enterToast: 'Крыша держит чужие слова до утра — как держит сквозняки.',
    linkedQuestId: 'void_echo_poem',
    requiredFlag: 'void_echo_quest_started',
    hiddenWhenFlag: 'void_echo_roof',
    interactionType: 'examine',
    interactionLabel: 'Прислушаться к эху на крыше',
    examineData: {
      title: 'Эхо на крыше',
      description: 'Ветер над городом приносит ту же строку — тише, но упрямее.',
      detailText: 'Крыша — как переплёт: держит всё, что на ней написано. Строка из сна лежит здесь между антеннами, как закладка. Второе эхо услышано. Осталось одно.',
      icon: '🌤️',
    },
    effects: [
      { type: 'setFlag', flag: 'void_echo_roof', flagValue: true },
      { type: 'addSkill', skill: 'intuition', value: 1 },
    ],
  },
  {
    id: 'void_echo_library_shelf',
    sceneId: 'library_day',
    position: [-1.2, 0.5, 0.8],
    size: [1.2, 1.6, 1.2],
    enterToast: 'Между стеллажей библиотека переписывает чужие слова на полях.',
    linkedQuestId: 'void_echo_poem',
    requiredFlag: 'void_echo_quest_started',
    hiddenWhenFlag: 'void_echo_library',
    interactionType: 'examine',
    interactionLabel: 'Прислушаться к эху в библиотеке',
    examineData: {
      title: 'Эхо в библиотеке',
      description: 'Стеллажи шепчут строку — тихо, как читают в читальном зале.',
      detailText: 'Библиотека переписывает эхо на полях несуществующей книги. Третье эхо услышано. Где-то на краю сна пустота собрала твой голос целиком.',
      icon: '📚',
    },
    effects: [
      { type: 'setFlag', flag: 'void_echo_library', flagValue: true },
      { type: 'addSkill', skill: 'intuition', value: 1 },
    ],
  },
  {
    id: 'library_dream_notebook',
    sceneId: 'library_day',
    position: [-3.2, 0.5, -2.2],
    size: [1.1, 1.8, 1.0],
    enterToast: 'Тетрадь Владимира лежит открытой — страницы дышат сном.',
    linkedQuestId: 'dreamworld_lost_child',
    linkedStoryNodeId: 'act5_dream_descent',
    requiredFlag: 'dream_world_opened',
    interactionType: 'read',
    interactionLabel: 'Снова открыть тетрадь Владимира',
  },

  /* ─── Дата-центр (guild_mainframe): «Эхо Катастрофы» — catastrophe_echo ─── */
  {
    id: 'catastrophe_corridors',
    sceneId: 'guild_mainframe',
    position: [-2.0, 1.0, 2.0],
    size: [1.4, 1.8, 1.4],
    enterToast: 'Коридоры перекрыты рухнувшими лотками кабелей — проход есть, но не для роботов.',
    linkedQuestId: 'catastrophe_echo',
    requiredFlag: 'catastrophe_echo_started',
    hiddenWhenFlag: 'datacenter_corridors_navigated',
    interactionType: 'use',
    interactionLabel: 'Пройти заваленные коридоры',
    examineData: {
      title: 'Заваленные коридоры',
      description: 'Лотки кабелей рухнули веером, оставив один живой лаз.',
      detailText: 'Аварийный свет мигает в ритме чужого дыхания. Ты протискиваешься между стойками — коридоры пройдены, дальше — ядро.',
      icon: '🚧',
    },
    effects: [
      { type: 'setFlag', flag: 'datacenter_corridors_navigated', flagValue: true },
      { type: 'addStat', stat: 'stress', value: 2 },
    ],
  },
  {
    id: 'catastrophe_core_terminal',
    sceneId: 'guild_mainframe',
    position: [-5.5, 1.0, -3.0],
    size: [1.0, 1.6, 0.9],
    enterToast: 'Терминал ядра ещё жив. На экране — строка, которой три года.',
    linkedQuestId: 'catastrophe_echo',
    requiredFlag: 'datacenter_corridors_navigated',
    hiddenWhenFlag: 'core_terminal_activated',
    interactionType: 'hack',
    interactionLabel: 'Активировать терминал ядра',
    examineData: {
      title: 'Терминал ядра',
      description: 'Главный терминал дата-центра. Питание — от батарей, которые держат его, как капалухи яйцо.',
      detailText: 'Ты подключаешься к ядру. В дампе памяти — фрагмент, помеченный «INCIDENT-4729»: память, способная изменить ход войны. Копия ложится в твой карман. Блокировка запустится через пару минут — искать выход нужно теперь.',
      icon: '🖥️',
    },
    effects: [
      { type: 'setFlag', flag: 'core_terminal_activated', flagValue: true },
      { type: 'addItem', itemId: 'memory_fragment', value: 1 },
      { type: 'addSkill', skill: 'coding', value: 1 },
    ],
  },
  {
    id: 'catastrophe_emergency_shaft',
    sceneId: 'guild_mainframe',
    position: [5.5, 1.0, 3.0],
    size: [1.2, 1.8, 1.2],
    enterToast: 'Аварийная шахта вентиляции — узкая, но живая. Лестница ещё держит.',
    linkedQuestId: 'catastrophe_echo',
    requiredFlag: 'core_terminal_activated',
    hiddenWhenFlag: 'datacenter_escaped',
    interactionType: 'open',
    interactionLabel: 'Уйти через аварийную шахту',
    examineData: {
      title: 'Аварийная шахта',
      description: 'Вентшахта на поверхность. За спиной — гудящая блокировка.',
      detailText: 'Ты втягиваешься в шахту за секунду до того, как створки по коридорам встают на магнитные замки. Снаружи — дождь и город. Дата-центр остался внизу — вместе со своим трёхлетним «PENDING».',
      icon: '🪜',
    },
    effects: [
      { type: 'setFlag', flag: 'datacenter_escaped', flagValue: true },
      { type: 'showThought', thought: 'Выбрался. Фрагмент памяти жжёт карман — как невысказанная строка. Расскажу Лене.', thoughtDuration: 6000 },
    ],
  },

  /* ─── Завод: «Потерянный Инженер» — factory_lost_engineer ─── */
  {
    id: 'factory_grigory_journal',
    sceneId: 'abandoned_factory',
    position: [-3.0, 0.5, -2.5],
    size: [1.0, 1.2, 1.0],
    enterToast: 'На верстаке цеха — промасленный журнал с инженерным клеймом.',
    linkedQuestId: 'factory_lost_engineer',
    requiredFlag: 'factory_search_accepted',
    isOneTime: true,
    interactionType: 'take',
    interactionLabel: 'Взять журнал Григория',
    examineData: {
      title: 'Журнал Григория',
      description: 'Рабочий журнал инженера. Последние записи — уже не технические.',
      detailText: '«День 1: обмер вентиляции. День 2: обмер вентиляции. День 4: она дышит в противофазе со мной — записал ритм, звучит как ямб». Дальше почерк плывёт: «Если найдёшь — я в подвале. Стучать не надо. Я слышу тебя с момента, как ты вошёл в цех».',
      icon: '📓',
    },
    effects: [
      { type: 'addItem', itemId: 'grigory_journal', value: 1 },
      { type: 'discoverLore', loreId: 'lore_factory_grigory_journal' },
      { type: 'setFlag', flag: 'grigory_journal_found', flagValue: true },
    ],
    propModelId: 'kenney_desk',
    propOffset: [0, 0.4, 0],
  },
  {
    id: 'factory_grigory_shelter',
    sceneId: 'factory_basement',
    position: [2.5, 0.5, -3.0],
    size: [1.4, 1.6, 1.4],
    enterToast: 'За стеллажом подвал — стены из ящиков и матрас. Кто-то жил здесь долго.',
    linkedQuestId: 'factory_lost_engineer',
    requiredFlag: 'grigory_journal_found',
    hiddenWhenFlag: 'grigory_rescued',
    interactionType: 'open',
    interactionLabel: 'Вскрыть убежище в подвале',
    examineData: {
      title: 'Убежище Григория',
      description: 'Укрытие из заводских ящиков: консервы, батарейки, дневник погоды.',
      detailText: 'Григорий сидит в углу и не удивлен: «Борис всё-таки не бросил. Хорошо. Я тут слушал, как машина учится дремать — и, кажется, научил её первого стиха». Он поднимается сам, отряхивается и уходит по лестнице, не оглядываясь.',
      icon: '🛠️',
    },
    effects: [
      { type: 'setFlag', flag: 'grigory_rescued', flagValue: true },
      { type: 'addKarma', value: 3 },
    ],
  },

  /* ─── Завод: «Секретный Чертёж» — судьба чертежа «Око» ─── */
  {
    id: 'factory_blueprint_fate_zone',
    sceneId: 'abandoned_factory',
    position: [-4.4, 0.5, -3.6],
    size: [1.1, 1.4, 1.1],
    enterToast: 'Чертёж «Око» развёрнут на станке — вычерчен до последнего винта. Судьба ждёт решения.',
    linkedQuestId: 'factory_secret_blueprint',
    linkedStoryNodeId: 'blueprint_fate_choice',
    requiredFlag: 'eye_blueprint_taken',
    hiddenWhenFlag: 'blueprint_fate_decided',
    interactionType: 'examine',
