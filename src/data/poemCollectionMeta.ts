 ...
 *
 * v4.8.4: акт 6 сознательно даёт 0 ОСНОВНЫХ стихов — его стихотворная дуга
 * живёт в скрытых актовых фрагментах poem_act6_01…poem_act6_08
 * (SPECIAL_BONUS_POEM_IDS, 100% completion), а не в основной дуге
 * poem_1…poem_21. Это не «дыра» сбора: основная дуга завершается в актах 1–5
 * и акте 7 (poem_21). Менять распределение нельзя — сломается прогресс-UI
 * журнала и golden-path подсказки.
 */
