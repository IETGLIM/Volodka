...
const ITEMS: ItemDefinition[] = [
  ...
  /* ── Оружие (v4.7.2 — слот weapon) ── */
  {
    id: 'debug_blade',
    name: 'Отладочный Клинок',
    description: 'Мониторный меч старой школы. Разрубает deadlock\'и и чужие firewall\'ы одним движением.',
    category: 'equipment',
    rarity: 'uncommon',
    icon: 'Sword',
    stackable: false,
  ...
  {
    id: 'logic_cannon',
    name: 'Логическая Пушка',
    description: 'Тяжёлый аргумент в споре с корпоративными системами. Стреляет чистой дедукцией.',
    category: 'equipment',
    rarity: 'rare',
    icon: 'Crosshair',
    stackable: false,
    ...
    effects: [
      { skill: 'logic', value: 3 },
      { skill: 'coding', value: 1 },
    ],
    equipmentSlot: 'weapon',
    combatBonus: [{ skill: 'logic', value: 3, type: 'flat' }, { skill: 'coding', value: 1, type: 'flat' }],
  },
  {
    id: 'empathy_tuner',
    name: 'Резонатор Эмпатии',
    description: 'Тонкий инструмент интроверта. Настраивает собеседника на твою волну — и бьёт этой волной.',
    category: 'equipment',
    rarity: 'uncommon',
    icon: 'AudioWaveform',
    stackable: false,
  ...
  },
  {
    id: 'verse_rapier',
    name: 'Рапира Стиха',
    description: 'Клинок, выкованный из рифмы. Легка, точна, оставляет раны, которые зарастают только новыми строками.',
    category: 'equipment',
    rarity: 'legendary',
    icon: 'Feather',
    stackable: false,
    ...
    equipmentSlot: 'weapon',
    combatBonus: [{ skill: 'writing', value: 3, type: 'flat' }, { skill: 'intuition', value: 1, type: 'flat' }],
  },
  {
    id: 'poetic_compiler',
  ...
  /* ── «Уличные легенды» (streetLegendsQuests) ── */
  {
    id: 'old_radio_transmitter',
    name: 'Старый радиопередатчик',
    description: 'Ламповый приёмник-передатчик с самодельной антенной из гвоздей. Мёртвый по всем реестрам гильдии, но лампа на корпусе мигает: три длинных, девять коротких. Колесо настройки стоит на частоте, которой нет в спецификациях.',
    category: 'quest_item',
    rarity: 'rare',
    icon: 'Radio',
    stackable: false,
  ...
  {
    id: 'sealed_parcel',
    name: 'Запечатанная посылка',
    description: 'Крафт-пакет, перетянутый бечёвкой, тяжёлый, как полтора кирпича. Пахнет обжаренным кофе. Швы целы — если и заглядывал внутрь кто-то, то очень давно и очень аккуратно.',
    category: 'quest_item',
    rarity: 'uncommon',
    icon: 'Package',
    stackable: false,
  ...
  {
    id: 'rat_king_crown',
    name: 'Крысиная корона',
    description: 'Связка оптоволокна, свитая крипами вокруг ржавой серверной стойки. Патрубки торчат, как зубцы. Мастер говорит — трофей. Баба Зина говорит — не носи домой.',
    category: 'quest_item',
    rarity: 'rare',
    icon: 'Crown',
    stackable: false,
  ...
  {
    id: 'lost_reading_glasses',
    name: 'Забытые очки',
    description: 'Очки в тонкой оправе с треснувшим левым стеклом. Дужка обмотана синей изолентой — дважды. Владелец, по словам Тамары, «читал так, что забывал не только очки, но и десятилетие, в котором живёт».',
    category: 'quest_item',
    rarity: 'common',
    icon: 'Glasses',
    stackable: false,
  ...
  },
  {
    id: 'lost_umbrella',
    name: 'Забытый зонт',
    description: 'Чёрный зонт с погнутым ребром и монограммой «А.К.». Стоит в библиотечном стояке столько, что персонал начал считать его частью интерьера. Тамара считает иначе.',
    category: 'quest_item',
    rarity: 'common',
    icon: 'Umbrella',
    stackable: false,
  ...
  {
    id: 'lost_tape',
    name: 'Забытая кассета',
    description: 'Кассета МК-60 без подписи, слипшаяся от старости. На корпусе нацарапано шилом: «тихий час». Судя по датчику остатка ленты, её слушали чаще, чем любую книгу из фонда.',
    category: 'quest_item',
    rarity: 'uncommon',
    icon: 'CassetteTape',
    stackable: false,
  ...
  /* ── «Эхо пирса» (v4.25, этап 112) ── */
  {
    id: 'ep_tape_echo',
    name: 'Кассета с эхом',
    description: 'Лента «Маяк-203» с записью эха пирса №3. На плёнке — голоса, которых не было на берегу: пирс повторяет то, о чём люди думают, стоя над водой, но не говорят вслух. Слушать лучше с кем-то — одному не разобрать, где твоё, а где чужое.',
    category: 'quest_item',
    rarity: 'uncommon',
    icon: 'Radio',
    stackable: false,
  ...
  {
    id: 'ep_glass_float',
    name: 'Поплавок из речного стекла',
    description: 'Стеклянный шар мутно-зелёного цвета — продукция завода «Хром-М», побочная линия семидесятых. Внутри пузырёк воздуха, застывший ровно посередине. Трофим говорит: такой поплавок не тонет даже в шторм, потому что пустота в нём — сознательно оставленная. Метафора он не поясняет.',
    category: 'misc',
    rarity: 'uncommon',
    icon: 'Sparkles',
    stackable: false,
    ...
    useMessage: 'Поплавок: держать его в руке почему-то спокойно. Стресс −3',
  },
  {
    id: 'ep_pier_postcard',
    name: 'Открытка «Пирс №3, 1987»',
    description: 'Выцветшая открытка из газетного киоска: деревянный пирс, штормовое небо, подпись художника в углу. На обороте чужим почерком: «Здесь тихо, даже когда громко. Приезжай». Марка не наклеена — отправитель, похоже, так и не решился.',
    category: 'misc',
    rarity: 'common',
    icon: 'FileText',
    stackable: false,
  ...
  {
    id: 'ep_lantern_battery',
    name: 'Батарея маяка',
    description: 'Тяжёлая бочонок-батарея из маяка на том берегу. Официально списана десять лет назад, фактически заряжена на восемьдесят процентов — маяк берегли. Вставляешь в любой фонарь — и темнота отступает на шаг. Пирсовые так и говорят: «свет не спрашивает, кто ты».',
    category: 'consumable',
    rarity: 'common',
    icon: 'Zap',
    stackable: true,
    maxStack: 3,
    effects: [{ stat: 'energy', value: 20 }],
    useMessage: 'Батарея маяка: ровный, независящий от сети свет. Энергия +20',
  },
