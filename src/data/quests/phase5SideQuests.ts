    ...
    objectives: [
      {
        ...
        type: 'location_visited',
        target: 'guild_checkpoint_basement',
        completed: false,
      },
      {
        id: 'free_engineer',
