              ...
              {menuItems.map((item, i) => {
                ...
                return (
                  <motion.button
                    ...
                    whileHover={!isDisabled ? { scale: 1.03, x: 4 } : undefined}
                    ...
                    {item.id === 'continue' && hasSave && (() => {
                      try {
                        ...
                        const sceneName = expl?.currentSceneId
                          ? { volodka_room: 'Комната', volodka_corridor: 'Коридор', street_night: 'Улица', cafe_evening: 'Кафе', office_day: 'Офис', park_day: 'Парк', library_day: 'Библиотека' }[expl.currentSceneId] ?? expl.currentSceneId
                          : '';
                        return (
