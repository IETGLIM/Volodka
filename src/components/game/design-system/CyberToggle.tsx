  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: checked ? 'rgba(0, 229, 255, 0.25)' : 'rgba(30, 41, 59, 0.8)',
          border: checked ? '1px solid rgba(0, 229, 255, 0.5)' : '1px solid rgba(71, 85, 105, 0.4)',
          boxShadow: checked ? '0 0 12px rgba(0, 229, 255, 0.3), inset 0 0 6px rgba(0, 229, 255, 0.15)' : 'none',
        }}
      >
        <motion.div
          ...
          animate={{
            ...
            background: checked ? 'rgba(0, 229, 255, 0.95)' : 'rgba(100, 116, 139, 0.6)',
