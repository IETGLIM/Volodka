...
const mat_4 = getSharedStandardMaterial({ color: '#9aa0a8', metalness: 0.55, roughness: 0.38 }); // brushed steel — not plastic chrome
...
const mat_35 = getSharedStandardMaterial({ color: '#3a3a3e', metalness: 0.42, roughness: 0.48 });
const mat_36 = getSharedStandardMaterial({ color: '#4a4a52', metalness: 0.45, roughness: 0.42 });
const mat_37 = getSharedStandardMaterial({ color: '#5a5a5e', metalness: 0.28, roughness: 0.55, side: THREE.DoubleSide });
const mat_38 = getSharedStandardMaterial({ color: '#3a3a3c', metalness: 0.48, roughness: 0.38 });
...
const mat_56 = getSharedStandardMaterial({ color: '#9aa0a8', metalness: 0.42, roughness: 0.44 });
...
const mat_67 = getSharedStandardMaterial({ color: '#848a92', metalness: 0.40, roughness: 0.46 });
