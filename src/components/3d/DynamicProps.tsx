 ...
 *
 *  [roadmap:PLYR-04] The player's KinematicCharacterController has
 *  applyImpulsesToDynamicBodies DISABLED (see characterControllerLifecycle.ts:47).
 *  Props are still pushed via Rapier's kinematic→dynamic contact resolution
 *  (the KCC's movement vector applies a contact impulse to overlapping dynamic
 *  bodies). This is less physically accurate than true impulse transfer but
 *  sufficient for light clutter. Remounts per scene (key=sceneId).
 */
