...
export const extendedQuestFromAISchema = z
  .object({
    ...
    cutsceneOnStart: z.string().optional(),
    cutsceneOnComplete: z.string().optional(),
    cutsceneOnObjective: z.record(z.string(), z.string()).optional(),
...
export function parseAIQuestPayload(payload: unknown): AIQuestParseResult {
  ...
  const quest: ExtendedQuest = {
    ...
    cutsceneOnStart: q.cutsceneOnStart,
    cutsceneOnComplete: q.cutsceneOnComplete,
    cutsceneOnObjective: q.cutsceneOnObjective,
