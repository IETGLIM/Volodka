  ...
  return (
    <div className="fixed inset-0 bg-black overflow-hidden pointer-events-none">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <motion.h1
          className={`relative text-[clamp(2rem,10vw,6rem)] font-bold tracking-[0.12em] ${titleGlitch ? 'title-glitch' : ''}`}
          style={{
        ...
        {/* Title reflection */}
        <div
          className="relative text-[clamp(2rem,10vw,6rem)] font-bold tracking-[0.12em] pointer-events-none select-none -mt-1"
          style={{
