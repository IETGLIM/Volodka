      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="game-critical-motion game-fm-layer game-panel game-panel-skin--briefing max-h-[min(78dvh,520px)] w-full max-w-md overflow-y-auto rounded-xl p-5 pb-[max(1.25rem,calc(1.25rem+env(safe-area-inset-bottom)))] outline-none ring-0"
          >
            <h2
