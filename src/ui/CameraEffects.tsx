...
} from '@/lib/explorationPostFxState';
...
const CameraEffects = memo(function CameraEffects({
  ...
  const aberrationOffset = useMemo(() => {
    const o = explorationChromaOffsetFromStress(stress, panicMode);
    return new THREE.Vector2(o.x, o.y);
  }, [stress, panicMode]);

  const bloomIntensity = useMemo(
    () => explorationBloomIntensityFromPlayer(creativity, karma),
    [creativity, karma],
  );
