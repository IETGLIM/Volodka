...
export const POEM_WORLD_EFFECT_OVERRIDES: Partial<Record<string, Partial<PoemWorldEffectProfile>>> = {
  ...
  // ── Bonus poem overrides (22–35) ──
  poem_22: {
    category: 'exploration',
    visualPreset: 'god_rays_gold',
    audioCue: 'mystery',
    durationMs: 4800,
    worldTint: 'rgba(180, 200, 255, 0.12)',
    narrationLine: '«Коридор — не пустота. Он полон шагов, которых ты ещё не сделал.»',
    worldHint: 'exit_glow',
  },
  poem_23: {
    category: 'utility',
    ...
    audioCue: 'discovery',
    durationMs: 4200,
    worldTint: 'rgba(200, 220, 255, 0.10)',
    narrationLine: '«С высоты всё выглядит иначе. Даже неон кажется маленьким.»',
    worldHint: 'interaction_pulse',
  },
  poem_25: {
    category: 'social',
    ...
    audioCue: 'emotional',
    durationMs: 5500,
    worldTint: 'rgba(255, 160, 140, 0.14)',
    narrationLine: '«Переработка — когда душа идёт на перегрузку, а мир требует ещё одну смену.»',
    worldHint: 'npc_shimmer',
  },
  poem_26: {
    category: 'combat',
    ...
    audioCue: 'danger',
    durationMs: 3800,
    worldTint: 'rgba(255, 80, 80, 0.16)',
    narrationLine: '«Сообщения — как пули: короткие, точные, оставляют следы.»',
    worldHint: 'none',
  },
  poem_27: {
    category: 'dialogue',
    ...
    audioCue: 'mystery',
    durationMs: 4500,
    worldTint: 'rgba(200, 180, 255, 0.12)',
    narrationLine: '«Голоса метро — хор тех, кого город проглотил и не переварил.»',
    worldHint: 'npc_shimmer',
  },
  poem_28: {
    category: 'exploration',
    ...
    audioCue: 'discovery',
    durationMs: 5000,
    worldTint: 'rgba(0, 255, 200, 0.14)',
    narrationLine: '«return void — функция, которая ничего не возвращает. Как жизнь, которая никуда не ведёт... пока не найдёшь стих.»',
    worldHint: 'interaction_pulse',
  ...
  poem_30: {
    ...
    audioCue: 'emotional',
    durationMs: 5200,
    worldTint: 'rgba(255, 200, 160, 0.12)',
    narrationLine: '«Мёртвый телефон — как могила без имени. Ты знаешь, кто звонил, но уже не ответишь.»',
    worldHint: 'npc_shimmer',
  },
  poem_35: {
    category: 'defense',
    ...
    audioCue: 'tension',
    durationMs: 4800,
    worldTint: 'rgba(100, 120, 255, 0.14)',
    narrationLine: '«Защита — не стена. Это ритм, который не даёт миру тебя сломать.»',
    worldHint: 'none',
  },
};
