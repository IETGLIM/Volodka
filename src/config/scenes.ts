...
export const SCENE_CONFIG = {
  ...
  dream: {
    ...
    npcs: [
      { id: 'lillian', name: 'Лилиан', model: 'barista', modelPath: '/models/khronos_cc0_RiggedFigure.glb', position: [0, 0, -4], dialogueTree: 'lillian_greeting' },
      { id: 'witch', name: 'Эмбер', model: 'shadow', modelPath: '/models/khronos_cc0_RiggedFigure.glb', position: [-3, 0, -2], dialogueTree: 'witch_greeting' },
      { id: 'galaxy', name: 'Астра', model: 'elder', modelPath: '/models/khronos_cc0_RiggedFigure.glb', position: [3, 0.5, -3], dialogueTree: 'galaxy_greeting' },
      { id: 'quester', name: 'Странник', model: 'colleague', modelPath: '/models/khronos_cc0_CesiumMan.glb', position: [2, 0, 1], dialogueTree: 'quester_greeting' }
    ],
    interactiveObjects: [],
    explorationTutorialHints: [
