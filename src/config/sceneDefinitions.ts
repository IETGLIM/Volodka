...
export const street_night_def: SceneDefinition = {
  ...
  lights: [
    ...
    { position: [-3.5, 4.5, 5], intensity: 2.4, color: '#ff2288', distance: 20 },
    { position: [4.5, 4, -5], intensity: 2.2, color: '#00eedd', distance: 18 },
    { position: [0, 6, -14], intensity: 1.6, color: '#6688ff', distance: 30 },
  ],
  ambientColor: '#353550',
