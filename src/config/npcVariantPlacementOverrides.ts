...
> = {
  ...
  albert_backroom: {
    ...
    albert: [-2.5, 0, -1.9],
    /* FIX (этап 95): act-4 оверрайд Виктории (двери кафе [-1.2, 3.2])
     * наследуется в подсобку — точка вне пола 8×6; перенос к дальней
     * стене [1.5, 0.5], вне капсулы шкафа [-1.5,-1]. */
    victoria: [1.5, 0, 0.5],
  },
