...
/* ═══════════════════════════════════════════════════════════
   AI LOD (v4.24, этап 97)
   ═══════════════════════════════════════════════════════════ */

/** Дальше этой дистанции (м) мирный крип (patrol/return/cooldown)
 *  симулируется на сниженной частоте: на экране он крошечный,
 *  а полный тик (LOS, пути, страйк-репорты, презентация) — самый
 *  дорогой пер-криповый расход. Бой/замах всегда реал-тайм. */
export const CREEP_AI_LOD_FAR_M = 30;

/** Период LOD-тика дальних крипов, с (~10 Гц). delta аккумулируется,
 *  поэтому движение/таймеры/зрение остаются точными по времени. */
export const CREEP_AI_LOD_FAR_TICK_S = 0.1;
