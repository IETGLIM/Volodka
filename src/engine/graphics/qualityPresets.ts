...
export const QUALITY_PRESETS: Record<Exclude<QualityPresetId, 'auto'>, QualityPreset> = {
  ...
  high: {
    ...
    bakedLighting: true,
    /**
     * [roadmap:GFX-08] Meshopt for high+ (was draco). Meshopt is faster to
     * decode and smaller than Draco for most meshes. All 220 GLBs have meshopt
     * variants shipped. Low/medium keep draco for older GPUs that may lack
     * meshopt WASM support (rare, but conservative for low-end).
     */
    compression: 'meshopt',
    npcRenderMode: 'hybrid',
    environmentRenderMode: 'hybrid',
