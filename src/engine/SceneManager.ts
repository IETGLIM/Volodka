...
export const SCENE_VISUALS: Record<SceneId, SceneVisualConfig> = {
  ...
  green_zone: {
    id: 'green_zone',
    name: 'Зелёнка',
    description: 'Дворы и гаражи между панельками',
    photoUrl: scenePhoto('street_night'),
    background: 'linear-gradient(180deg, #0a1a0a 0%, #122012 50%, #1a2a18 100%)',
    overlay: 'bg-gradient-to-t from-green-950/30 to-transparent',
    ambientColor: '#22c55e',
    musicKey: 'ambient_night',
  },
  district: {
    id: 'district',
    name: 'Район',
    description: 'Быт и шум обычного городского квартала',
    photoUrl: scenePhoto('street_night'),
    background: 'linear-gradient(180deg, #0f0a08 0%, #1a1410 50%, #261c12 100%)',
    overlay: 'bg-gradient-to-t from-orange-950/25 to-transparent',
    ambientColor: '#f59e0b',
    musicKey: 'ambient_evening',
  },
  mvd: {
    id: 'mvd',
    name: 'МВД',
    description: 'Светлый коридор и холод формализма',
    photoUrl: scenePhoto('office_morning'),
    background: 'linear-gradient(180deg, #0a1018 0%, #121a28 50%, #1a2430 100%)',
    overlay: 'bg-gradient-to-t from-slate-900/35 to-transparent',
    ambientColor: '#60a5fa',
    musicKey: 'ambient_office',
  },
  president_hotel: {
    ...
    description: 'Пафос, лобби, отражения в мраморе',
    photoUrl: scenePhoto('office_morning'),
    background: 'linear-gradient(180deg, #1a1508 0%, #2a2010 50%, #3a2818 100%)',
    overlay: 'bg-gradient-to-t from-amber-900/40 to-transparent',
    ambientColor: '#fcd34d',
    musicKey: 'ambient_calm',
  },
  zarema_albert_room: {
    ...
    description: 'Тесно, тепло, чужие инструменты и чай',
    photoUrl: scenePhoto('kitchen_dawn'),
    background: 'linear-gradient(180deg, #181210 0%, #252018 45%, #322818 100%)',
    overlay: 'bg-gradient-to-t from-amber-950/25 to-transparent',
    ambientColor: '#fcd34d',
    musicKey: 'ambient_home',
  },
