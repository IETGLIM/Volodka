...
export const SCENE_ENV_LOD: Partial<Record<string, EnvironmentLodProfile>> = {
  ...
  volodka_corridor: { clutterDistance: 9, decorativeDistance: 13 },
  home_evening: { clutterDistance: 10, decorativeDistance: 14 },
  library_day: { clutterDistance: 13, decorativeDistance: 20 },
  ...
  library_basement: { clutterDistance: 10, decorativeDistance: 15 },
