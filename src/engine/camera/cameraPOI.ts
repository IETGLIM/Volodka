 ...
 *    setCameraPOITarget(new Vector3(1, 1.5, -3));
 *
...
let poiTarget: Vector3 | null = null;
 ...
 */
export function setCameraPOITarget(position: Vector3): void {
 ...
 */
export function getCameraPOI(dt: number): Vector3 | null {
