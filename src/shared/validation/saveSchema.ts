...
export const SavePayloadSchema = z.object({
  ...
  /**
   * [roadmap:CMBT-07] Combat difficulty setting — persisted to save so
   * cross-machine save sharing preserves the player's preference. Previously
   * localStorage-only, lost when sharing saves.
   */
  combatDifficulty: z.enum(['story', 'normal', 'hard']).optional().default('normal'),
  savedAt: z.number(),
