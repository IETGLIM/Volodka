...
const PLAYER_KEYS = new Set<keyof PlayerSlice>(['playerState','lastUsedPoemId','lastUsedPoemTimestamp','pendingPoemReadingId','notifications','activeTTLFlags','acquiredThoughtIds','equippedThoughtIds','thoughtInternalizationPoints','visitNode','addSkill','addKarma','addStress','addEnergy','setFlag','pushNotification','dismissNotification','restAtHome','autoRegenBetweenScenes','upsertActiveTTLFlag','upsertActiveTTLFlags','upsertHintFlagWithTTL','removeActiveTTLFlags','clearActiveTTLFlags','advanceAct','applyPlayerRewardBatch','addItem','removeItem','equipItem','unequipItem','addXp','addCredits','unlockSkillTreeNode','canUnlockSkill','acquirePerk','canAcquirePerk','getActivePerkEffects','craftItem','canCraft','buyItem','sellItem','canBuyItem','canSellItem','giftItemToNPC','completeQuestAndApplyRewards','advanceThoughtInternalization','getThoughtInternalizationFraction']);
