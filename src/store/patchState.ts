...
const UI_KEYS = new Set<keyof UISlice>(['mode','mainMenuOpen','introActive','combatActive','currentNodeId','lastSaveTimestamp','lastAutoSaveTimestamp','showStoryOverlay','diegeticNarrative','narrativeKind','devToolsArmed','matrixRainEnabled','glitchIntensity','noirMode','tutorialFlags','musicVolume','musicEnabled','journalOpen','journalTab','loreEntries','conversationLog','introSeen','setMainMenuOpen','setIntroActive','setCombatActive','setCurrentNodeId','setShowStoryOverlay','openNarrativeOverlay','closeNarrativeOverlay','openDiegeticNarrative','closeDiegeticNarrative','setNarrativeKind','armDevTools','toggleMatrixRain','setGlitchIntensity','toggleNoirMode','setMusicVolume','toggleMusic','toggleJournal','setJournalTab','setJournalOpen','addLoreEntry','discoverLoreEntry','addConversationLog','setIntroSeen']);
