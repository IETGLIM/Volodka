...
Сводка для «AAA+» ощущения без тяжёлых снапшот-тестов: что уже завязано на код и что сверять с [ART_BIBLE.md](./ART_BIBLE.md). Таблица сцен × IBL × кибер-грейд и P-бэклог: [visual-ui-aaa-audit-backlog.md](./visual-ui-aaa-audit-backlog.md).
