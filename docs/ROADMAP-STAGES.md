...
2. Реестр закрыт (132/132, v4.32.0). Фаза 10: этап 133 (KTX2 внешних карт),
   этап 134 (волна v4.33.0) и этап 135 (волна v4.35.0) ЗАКРЫТЫ. Очередь:
   пер-сценная экспозиция ToneMapping, CoherentNoiseEffect,
   ...
   WebP-фолбэка из keep-set (−11 MB) и визуальная QA фиксов этапа 135
   (лестницы/фонари/баки на площади, тайлинг, силуэт фасадов).
