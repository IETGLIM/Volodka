...
- **~142 квеста**: основная линия, побочные, скрытые, ежедневные миссии, «ЧК · ТОЛПА» и «Уличные легенды» (плотный playtime ~10–40 h; 120 h — целевая фабрика, не текущий shipped объём).
- **Стелс и бой**: патрули, конусы зрения с line-of-sight и leash-радиусами (WoW-стиль), погоня по nav mesh, побег, turn-based combat с телеграфированием спец-атак и фазами боссов, комбо, баффы, дебаффы и разные типы врагов.
