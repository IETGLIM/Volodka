...
- **~147 квестов (145 достижимы)**: основная линия, побочные, скрытые, ежедневные миссии, «ЧК · ТОЛПА» и «Уличные легенды» (плотный playtime ~10–40 h; 120 h — целевая фабрика, не текущий shipped объём).
